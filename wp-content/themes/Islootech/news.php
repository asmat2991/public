                ...
                while ($custom_posttype_news->have_posts()) {
                    ...
                    <?php if ($count == 1) { ?>
                        <div class="col-lg-6 mb-md-5 mb-4 pb-md-4 pb-2 mb-lg-0 blothoth">
                            ...
                            <a class="btn rounded-pill" href="#">Technology</a>
                            <a class="btn rounded-pill ms-2" href="#">Beats</a>

                        </div>
                        <div class="col-lg-6 mb-5 farse_img">
                            <img class="img-fluid rounded farse_img" src="<?php the_post_thumbnail_url(); ?>" alt="">
                        </div>
                    <?php } ?>
