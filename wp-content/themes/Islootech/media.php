    ...
    <div class="container first_section contaner_width position-relative">
        ...
        <div class="row baner_contaner_b">
            <div class="col-md-12 text-center d-flex flex-column justify-content-end h-100">
                <div class="">
                    <h1 class="mt-4">Our Latest Digital Insights</h1>
                    <p class="mb-1">
        ...
        <div class="container position-relative mt-5 pt-5  border-top contaner_width">
            ...
            <div class="row pt-md-5 pt-3 w-100 m-0">
                ...
                while ($custom_posttype_news->have_posts()) {
                    ...
                    <?php if ($count == 1) { ?>
                        <div class="col-lg-6 mb-md-5 mb-4 pb-md-4 pb-2 mb-lg-0 blothoth">
                            ...
                            if ($post_categories) {
                                foreach ($post_categories as $category) {
                                    echo '<a class="btn rounded-pill" href="' . esc_url(get_category_link($category->term_id)) . '">' . esc_html($category->name) . '</a> ';
                                }
                            }
                            ?>
            ...
            echo paginate_links(array(
                'total'   => $custom_posttype_news->max_num_pages,
...
<section class="">
    <div class="container-fluid py-5">
        <div class="row mt-md-5 mbl_scr">
            <div class="col-md-12">
                <ul class="scroll_left2 d-flex mb-1 justify-content-lg-start justify-content-center list-unstyled web_type_ul flex-wrap p-0 gap-3">
                ...
                <ul class="scroll_right2 d-flex justify-content-lg-end mb-0 justify-content-center list-unstyled web_type_ul flex-wrap p-0 gap-3">
                    <li class="text-nowrap">
                        <h1 class="">
